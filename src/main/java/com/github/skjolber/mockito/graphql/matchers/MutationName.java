...
public class MutationName extends AbstractValueMatcher {

    public MutationName(String name, Map<String, Object> variables) {
		super(name, variables, Operation.MUTATION);
	}
